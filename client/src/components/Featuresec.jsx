  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
        ...
        <div className='flex flex-col justify-center md:flex-row items-center md:items-stretch gap-6 mb-20'>
            <button className='px-6 py-3 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer mt-5' onClick={()=>{navigate("/movies"); scrollTo(0,0)}} >
                Show More
            </button>
        </div>
